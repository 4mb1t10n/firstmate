...
That command installs the pinned ShellCheck into a throwaway directory first, so the gate lints in a fresh environment without anything preinstalled on the host.
