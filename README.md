...
- [docs/reconciliation-heartbeat.md](docs/reconciliation-heartbeat.md) - the periodic GitHub-to-fleet control loop: cadence selection, issue leases, durable acknowledgement, process ownership, and the feature-to-`stg` merge gate.
